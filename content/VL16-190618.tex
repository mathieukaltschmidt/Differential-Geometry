...
\end{align}
\end{bew}
Zsection{$(\mfk, g)$ als metrischer Raum} 
...
\end{figure} 
In Abbildung \ref{img:exponentialfunction} ist zu sehen, dass der Strahl $t v$ auf radiale Geodätische $c_v(t) = \exp_p (t v)$ abgebildet wird durch due Exponentialabbildung.
