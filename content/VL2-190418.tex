...
\item $S_R^n = \{ (x_0, \dots, x_n) \in \real^{n+1} \vert \sum_{i=0}^n x_i^2 = R^2 \} \subset \real^{n+1}$

\begin{itemize}
\item Teilraumtopologie: $U \subset S^n_R$ offen $\Leftrightarrow \exists U' \subset \real^{n+1}$ offen mit $U = U' \cap S^n_R$
