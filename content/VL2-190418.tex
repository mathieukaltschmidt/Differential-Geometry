...
\item[Wichtig:] Hausdorfsch + 2. Abzählberkeitsaxiom $\Rightarrow$ parakompakt, d. h. jede offene Überdeckung hat eine lokale Verfeinerung.
\end{description}
...
\begin{bsp}[differenzierbare Mannigfaltigen]
\begin{enumerate}
...
\item$M_1 = S^1,\ M_2 = \R,\ M_1\times M_2 =$ "unendlicher Zylinder" \todo{Graphik: Zylinder}
...
sodass
\begin{enumerate}
\item$f(N)\subset M$ eine Untermannigfaltigkeit \todo{ich bin mir nicht sicher ob das da wirklich steht}
\item$f: N \rightarrow f(N)$ Diffeomorphismus
\end{enumerate}
\end{defs}

\section{Tangentialraum} \todo{ich weiß auch nicht ob wir bei "Unterüberschriften" section nehmen}

\todo{Graphik: Tangentialräume}
