...
\fancypagestyle{plain}{%
	...
	\fancyfoot[C]{%
        	\colorbox{mygray}{\color{white}\textbf{\thepage}}}
...
\usepackage[explicit]{titlesec}
	...
	\newcommand*\chapterlabel{}
    	\titleformat
			{\chapter} % command
			[display] % shape
			{\bfseries\color{mygray}} % format
			{\colorbox{mygray}{            	\chapternumberfontsize{\textcolor{white}{\thechapter.}}}\hspace{5pt}\huge{\chaptertitlename} % 
                \\[12pt]
                \fontsize{20}{24}\selectfont \color{black}{#1}
     		} % label 
			{0pt} % sep
			{
    			\vspace{-10pt}
